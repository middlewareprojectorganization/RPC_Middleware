...
public abstract class ReferenceConfigBase<T> extends AbstractReferenceConfig {
    ...
    public ReferenceConfigBase(RpcReference rpcReference) {
        serviceMetadata = new ServiceMetadata();
        serviceMetadata.addAttribute("ORIGIN_CONFIG", this);
        appendAnnotation(RpcReference.class, rpcReference);
        setMethods(MethodConfig.constructMethodConfig(rpcReference.methods()));
    }
