...
public abstract class ServiceConfigBase<T> extends AbstractServiceConfig {
    ...
    public ServiceConfigBase(RpcService rpcService) {
        serviceMetadata = new ServiceMetadata();
        serviceMetadata.addAttribute("ORIGIN_CONFIG", this);
        appendAnnotation(RpcService.class, rpcService);
        setMethods(MethodConfig.constructMethodConfig(rpcService.methods()));
    }
