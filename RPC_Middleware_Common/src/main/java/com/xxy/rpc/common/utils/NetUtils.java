...
public class NetUtils {
    ...
    public static String getLocalHost() {
        ...
        return address == null ? CommonConstants.LOCALHOST_VALUE : address.getHostAddress();
    }
    ...
    public static String getIpByConfig() {
        String configIp = ConfigurationUtils.getProperty(CommonConstants.DUBBO_IP_TO_BIND);
        if (configIp != null) {
            return configIp;
        }
