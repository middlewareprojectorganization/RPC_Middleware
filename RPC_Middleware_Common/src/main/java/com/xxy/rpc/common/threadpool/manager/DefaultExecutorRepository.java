 ...
 */
package com.xxy.rpc.common.threadpool.manager;
...
import com.xxy.rpc.common.threadpool.support.limited.LimitedThreadPool;
...
//        reconnectScheduledExecutor = Executors.newSingleThreadScheduledExecutor(new NamedThreadFactory("Dubbo-reconnect-scheduler"));
    ...
    private ExecutorService createExecutor(URL url) {
        return (ExecutorService)new LimitedThreadPool().getExecutor(url);
    }
