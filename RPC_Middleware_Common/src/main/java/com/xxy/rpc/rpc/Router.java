 ...
 *
 * @see com.xxy.rpc.rpc.cluster.Cluster#join(Directory)
 * @see com.xxy.rpc.rpc.cluster.Directory#list(Invocation)
 */
public interface Router extends Comparable<com.xxy.rpc.rpc.cluster.Router> {
     ...
     * chance to prepare before {@link com.xxy.rpc.rpc.cluster.Router#route(List, URL, Invocation)} gets called.
     *
     * @param invokers invoker list
    ...
    @Override
    default int compareTo(com.xxy.rpc.rpc.cluster.Router o) {
        if (o == null) {
