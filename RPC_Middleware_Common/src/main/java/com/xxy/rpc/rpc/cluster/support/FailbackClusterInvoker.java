...
public class FailbackClusterInvoker<T> extends AbstractClusterInvoker<T> {
    ...
    public FailbackClusterInvoker(Directory<T> directory) {
        ...
        int retriesConfig = getUrl().getParameter(CommonConstants.RETRIES_KEY, CommonConstants.DEFAULT_FAILBACK_TIMES);
        if (retriesConfig <= 0) {
            retriesConfig = CommonConstants.DEFAULT_FAILBACK_TIMES;
        }
