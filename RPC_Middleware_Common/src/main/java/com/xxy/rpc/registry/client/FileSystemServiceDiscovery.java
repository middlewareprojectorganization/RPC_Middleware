...
import com.xxy.rpc.common.config.configcenter.file.FileSystemDynamicConfiguration;
...
public class FileSystemServiceDiscovery implements ServiceDiscovery, EventListener<ServiceInstancesChangedEvent> {
    ...
    private void registerListener() {
        getServices().forEach(serviceName -> {
            dynamicConfiguration.getConfigKeys(DynamicConfiguration.DEFAULT_GROUP).forEach(serviceInstanceId -> {
    ...
    public List<ServiceInstance> getInstances(String serviceName) {
        return dynamicConfiguration.getConfigKeys(DynamicConfiguration.DEFAULT_GROUP)
                .stream()
    ...
    private static FileSystemDynamicConfiguration createDynamicConfiguration(URL connectionURL) {
        ...
        return new FileSystemDynamicConfiguration(connectionURL.addParameter(FileSystemDynamicConfiguration.CONFIG_CENTER_DIR_PARAM_NAME, path));
    }
}
