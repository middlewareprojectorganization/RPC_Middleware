...
public interface RegistryService {
     ...
     *
     * @param url  Registration information , is not allowed to be empty, e.g: dubbo://10.20.153.10/com.xxy.rpc.foo.BarService?version=1.0.0&application=kylin
     */
     ...
     * 3. Allow interface, group, version, and classifier as a conditional query, e.g.: interface=com.xxy.rpc.foo.BarService&version=1.0.0<br>
     ...
     *
     * @param url      Subscription condition, not allowed to be empty, e.g. consumer://10.20.153.10/com.xxy.rpc.foo.BarService?version=1.0.0&application=kylin
     ...
     *
     * @param url Query condition, is not allowed to be empty, e.g. consumer://10.20.153.10/com.xxy.rpc.foo.BarService?version=1.0.0&application=kylin
