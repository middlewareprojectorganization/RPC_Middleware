 ...
 *
 */
public interface Configurator extends Comparable<org.apache.dubbo.rpc.cluster.Configurator> {
     ...
     */
    static Optional<List<org.apache.dubbo.rpc.cluster.Configurator>> toConfigurators(List<URL> urls) {
        ...
        List<org.apache.dubbo.rpc.cluster.Configurator> configurators = new ArrayList<>(urls.size());
        for (URL url : urls) {
     ...
     */
    @Override
    default int compareTo(org.apache.dubbo.rpc.cluster.Configurator o) {
        if (o == null) {
            return -1;
        }
