 ...
 */
public interface Router extends Comparable<org.apache.dubbo.rpc.cluster.Router> {
     ...
     * chance to prepare before {@link org.apache.dubbo.rpc.cluster.Router#route(List, URL, Invocation)} gets called.
     *
     * @param invokers invoker list
