...
/**
 * {@link RpcConfigBeanCustomizer} for the default value for the "name" property that will be taken bean name
 * if absent.
 *
 * @since 2.6.6
 */
public class NamePropertyDefaultValueRpcConfigBeanCustomizer implements RpcConfigBeanCustomizer {

    /**
     * The bean name of {@link NamePropertyDefaultValueRpcConfigBeanCustomizer}
     *
     * @since 2.7.1
     */
