...
import com.xxy.rpc.spring.context.config.NamePropertyDefaultValueDubboConfigBeanCustomizer;
import com.xxy.rpc.spring.beans.factory.annotation.DubboConfigBindingBeanPostProcessor;
import com.xxy.rpc.spring.beans.factory.config.ConfigurableSourceBeanMetadataElement;
...
public class DubboConfigBindingRegistrar implements ImportBeanDefinitionRegistrar, EnvironmentAware,
    ...
    public void registerBeanDefinitions(AnnotationMetadata importingClassMetadata, BeanDefinitionRegistry registry) {
        ...
        AnnotationAttributes attributes = fromMap(importingClassMetadata.getAnnotationAttributes(EnableRpcConfigBinding.class.getName()));
    ...
    private void registerDubboConfigBeanCustomizers(BeanDefinitionRegistry registry) {
        registerInfrastructureBean(registry, NamePropertyDefaultValueDubboConfigBeanCustomizer.BEAN_NAME, NamePropertyDefaultValueDubboConfigBeanCustomizer.class);
    }
