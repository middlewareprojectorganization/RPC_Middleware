...
import com.xxy.rpc.common.bytecode.Wrapper;
...
import com.xxy.rpc.config.event.ReferenceConfigDestroyedEvent;
import com.xxy.rpc.config.event.ReferenceConfigInitializedEvent;
...
import com.xxy.rpc.rpc.Cluster;
...
import com.xxy.rpc.rpc.model.ConsumerModel;
import com.xxy.rpc.rpc.model.ServiceDescriptor;
import com.xxy.rpc.rpc.model.ServiceRepository;
import com.xxy.rpc.rpc.protocol.injvm.InjvmProtocol;
import com.xxy.rpc.rpc.service.GenericService;
...
import static com.xxy.rpc.rpc.cluster.Constants.REFER_KEY;
...
public class ReferenceConfig<T> extends ReferenceConfigBase<T> {
     ...
     * For example:
     *
     * <li>when the url is registry://224.5.6.7:1234/com.xxy.rpc.registry.RegistryService?application=dubbo-sample,
     * then the protocol is <b>RegistryProtocol</b></li>
     *
     * <li>when the url is dubbo://224.5.6.7:1234/com.xxy.rpc.config.api.DemoService?application=dubbo-sample, then
     * the protocol is <b>DubboProtocol</b></li>
     * <p>
     * layers, and eventually will get a <b>ProtocolFilterWrapper</b> or <b>ProtocolListenerWrapper</b>
     */
    private static final Protocol REF_PROTOCOL = null;

    /**
     * The {@link Cluster}'s implementation with adaptive functionality, and actually it will get a {@link Cluster}'s
     * specific implementation who is wrapped with <b>MockClusterInvoker</b>
     */
    private static final Cluster CLUSTER = null;
    ...
    public ReferenceConfig(RpcReference rpcReference) {
        super(rpcReference);
    }
...
//                    consumerModel.getMethodModel(methodConfig.getName()).addAttribute(ASYNC_KEY, asyncMethodInfo);
    ...
    public void appendParameters() {
        ...
        List<AppendParametersComponent> appendParametersComponents = null;
