...
import com.xxy.rpc.common.config.configcenter.wrapper.CompositeDynamicConfiguration;
import com.xxy.rpc.common.constants.CommonConstants;

import com.xxy.rpc.common.function.ThrowableAction;
import com.xxy.rpc.common.lang.ShutdownHookCallback;
...
import com.xxy.rpc.common.threadpool.concurrent.ScheduledCompletableFuture;
import com.xxy.rpc.common.threadpool.manager.DefaultExecutorRepository;
import com.xxy.rpc.common.threadpool.manager.ExecutorRepository;
import com.xxy.rpc.common.utils.CollectionUtils;
import com.xxy.rpc.common.utils.StringUtils;
import com.xxy.rpc.config.*;
import com.xxy.rpc.config.bootstrap.builders.*;
import com.xxy.rpc.configcenter.ConfigCenterDynamicConfiguration;
import com.xxy.rpc.event.DirectEventDispatcher;
import com.xxy.rpc.event.EventDispatcher;
import com.xxy.rpc.event.EventListener;
...
import com.xxy.rpc.registry.client.DefaultServiceInstance;
import com.xxy.rpc.registry.client.ServiceDiscovery;
import com.xxy.rpc.registry.client.ServiceDiscoveryRegistry;
...
import com.xxy.rpc.config.metadata.ConfigurableMetadataServiceExporter;
import com.xxy.rpc.config.utils.ConfigValidationUtils;
import com.xxy.rpc.config.utils.ReferenceConfigCache;
...
public class DubboBootstrap extends GenericEventListener {
    ...
    private final ExecutorRepository executorRepository = new DefaultExecutorRepository();
    ...
    private String getMetadataType() {
        ...
        if (StringUtils.isEmpty(type)) {
            type = CommonConstants.DEFAULT_METADATA_STORAGE_TYPE;
        }
        return type;
    }
    ...
    private void startMetadataReport() {
        ...
        if (CollectionUtils.isEmpty(metadataReportConfigs)) {
            if (CommonConstants.REMOTE_METADATA_STORAGE_TYPE.equals(metadataType)) {
    ...
    /**
     * Initialize {@link com.xxy.rpc.event.EventListener}
     */
    ...
    private DynamicConfiguration prepareEnvironment(ConfigCenterConfig configCenter) {
        if (configCenter.isValid()) {
            ...
            DynamicConfiguration dynamicConfiguration = new ConfigCenterDynamicConfiguration(configCenter.toUrl());
            ...
            try {
                ...
                environment.updateExternalConfigurationMap(ConfigurationUtils.parseProperties(configContent));
                environment.updateAppExternalConfigurationMap(ConfigurationUtils.parseProperties(appConfigContent));
            } catch (IOException e) {
    ...
    /**
     * Add an instance of {@link com.xxy.rpc.event.EventListener}
     *
     * @param listener {@link com.xxy.rpc.event.EventListener}
     * @return {@link DubboBootstrap}
     */
    ...
    private ServiceInstance createServiceInstance(String serviceName, String host, int port) {
        ...
        ServiceInstanceMetadataUtils.setMetadataStorageType(serviceInstance, getMetadataType());
